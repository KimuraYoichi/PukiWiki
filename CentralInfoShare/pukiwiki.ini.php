...
$page_title = 'セントラルソフト情報共有';

// Specify PukiWiki URL (default: auto)
$script = 'http://realdaddy.la.coocan.jp/CentralInfoShare/';

// Shorten $script: Cut its file name (default: not cut)
//$script_directory_index = 'index.php';

// Site admin's name (CHANGE THIS)
$modifier = 'YoichiKimura';

// Site admin's Web page (CHANGE THIS)
$modifierlink = 'http://realdaddy.la.coocan.jp/CentralInfoShare/';
...
// Default: always fail
$adminpass = '{x-php-md5}f9f1f536912b7a36dd991997ec1ca4cf';

<?php /* Smarty version 2.6.18, created on 2012-06-19 21:47:31
         compiled from file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/pc/templates/common/layout.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 't_escape', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/pc/templates/common/layout.tpl', 9, false),array('modifier', 't_url2cmd', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/pc/templates/common/layout.tpl', 63, false),array('modifier', 't_cmd', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/pc/templates/common/layout.tpl', 63, false),array('function', 't_url_style', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/pc/templates/common/layout.tpl', 10, false),array('function', 't_url', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/pc/templates/common/layout.tpl', 24, false),array('function', 't_img_url', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/pc/templates/common/layout.tpl', 50, false),array('function', 't_img_url_skin', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/pc/templates/common/layout.tpl', 71, false),)), $this); ?>
...
&amp;sessid=<?php echo smarty_modifier_t_escape($this->_tpl_vars['PHPSESSID']); ?>
" target="_blank"><img src="<?php echo smarty_function_t_img_url(array('filename' => smarty_modifier_t_escape($this->_tpl_vars['INC_HEADER_top_banner']['image_filename'])), $this);?>
" alt="<?php echo smarty_modifier_t_escape($this->_tpl_vars['INC_HEADER_top_banner']['nickname']); ?>
" /></a>
<?php else: ?>
<a href="<?php echo smarty_function_t_url(array('m' => 'pc','a' => 'do_o_click_banner'), $this);?>
&amp;target_c_banner_id=<?php echo smarty_modifier_t_escape($this->_tpl_vars['INC_HEADER_top_banner']['c_banner_id']); ?>
" target="_blank"><img src="<?php echo smarty_function_t_img_url(array('filename' => smarty_modifier_t_escape($this->_tpl_vars['INC_HEADER_top_banner']['image_filename'])), $this);?>
" alt="<?php echo smarty_modifier_t_escape($this->_tpl_vars['INC_HEADER_top_banner']['nickname']); ?>
" /></a>
...
<div id="sideBanner">
<?php echo ''; ?><?php if ($this->_tpl_vars['INC_FOOTER_side_banner_html_before'] || $this->_tpl_vars['INC_FOOTER_side_banner_html_after']): ?><?php echo ''; ?><?php if ($this->_tpl_vars['before_after'] == 'before'): ?><?php echo ''; ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['INC_FOOTER_side_banner_html_before'])) ? $this->_run_mod_handler('t_url2cmd', true, $_tmp, 'side_banner') : smarty_modifier_t_url2cmd($_tmp, 'side_banner')))) ? $this->_run_mod_handler('t_cmd', true, $_tmp, 'side_banner') : smarty_modifier_t_cmd($_tmp, 'side_banner')); ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['INC_FOOTER_side_banner_html_after'])) ? $this->_run_mod_handler('t_url2cmd', true, $_tmp, 'side_banner') : smarty_modifier_t_url2cmd($_tmp, 'side_banner')))) ? $this->_run_mod_handler('t_cmd', true, $_tmp, 'side_banner') : smarty_modifier_t_cmd($_tmp, 'side_banner')); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php elseif ($this->_tpl_vars['INC_FOOTER_inc_side_banner']): ?><?php echo ''; ?><?php if ($this->_tpl_vars['INC_FOOTER_inc_side_banner']['a_href']): ?><?php echo ''; ?><?php if ($this->_tpl_vars['before_after'] == 'after'): ?><?php echo '<a href="'; ?><?php echo smarty_function_t_url(array('m' => 'pc','a' => 'do_h_click_banner'), $this);?><?php echo '&amp;target_c_banner_id='; ?><?php echo smarty_modifier_t_escape($this->_tpl_vars['INC_FOOTER_inc_side_banner']['c_banner_id']); ?><?php echo '&amp;sessid='; ?><?php echo smarty_modifier_t_escape($this->_tpl_vars['PHPSESSID']); ?><?php echo '" target="_blank"><img src="'; ?><?php echo smarty_function_t_img_url(array('filename' => smarty_modifier_t_escape($this->_tpl_vars['INC_FOOTER_inc_side_banner']['image_filename'])), $this);?><?php echo '" alt="'; ?><?php echo smarty_modifier_t_escape($this->_tpl_vars['INC_FOOTER_inc_side_banner']['nickname']); ?><?php echo '" /></a>'; ?><?php else: ?><?php echo '<a href="'; ?><?php echo smarty_function_t_url(array('m' => 'pc','a' => 'do_o_click_banner'), $this);?><?php echo '&amp;target_c_banner_id='; ?><?php echo smarty_modifier_t_escape($this->_tpl_vars['INC_FOOTER_inc_side_banner']['c_banner_id']); ?><?php echo '" target="_blank"><img src="'; ?><?php echo smarty_function_t_img_url(array('filename' => smarty_modifier_t_escape($this->_tpl_vars['INC_FOOTER_inc_side_banner']['image_filename'])), $this);?><?php echo '" alt="'; ?><?php echo smarty_modifier_t_escape($this->_tpl_vars['INC_FOOTER_inc_side_banner']['nickname']); ?><?php echo '" /></a>'; ?><?php endif; ?><?php echo ''; ?><?php else: ?><?php echo '<img src="'; ?><?php echo smarty_function_t_img_url(array('filename' => smarty_modifier_t_escape($this->_tpl_vars['INC_FOOTER_inc_side_banner']['image_filename'])), $this);?><?php echo '" alt="'; ?><?php echo smarty_modifier_t_escape($this->_tpl_vars['INC_FOOTER_inc_side_banner']['nickname']); ?><?php echo '" />'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?>

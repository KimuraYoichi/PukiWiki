<?php /* Smarty version 2.6.18, created on 2012-06-19 21:45:23
         compiled from file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/inc_dashboard.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 't_assign_sns_info', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/inc_dashboard.tpl', 5, false),array('function', 't_assign_sns_ranking', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/inc_dashboard.tpl', 22, false),array('function', 't_url', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/inc_dashboard.tpl', 30, false),array('function', 't_assign_sns_message', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/inc_dashboard.tpl', 44, false),array('function', 't_assign_sns_new_diary', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/inc_dashboard.tpl', 58, false),array('function', 't_assign_sns_new_topic', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/inc_dashboard.tpl', 72, false),array('function', 't_assign_sns_new_review', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/inc_dashboard.tpl', 86, false),array('function', 't_assign_sns_new_member', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/inc_dashboard.tpl', 100, false),array('function', 'fetch', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/inc_dashboard.tpl', 117, false),array('modifier', 't_escape', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/inc_dashboard.tpl', 8, false),array('modifier', 'number_format', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/inc_dashboard.tpl', 8, false),array('modifier', 'date_format', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/inc_dashboard.tpl', 51, false),)), $this); ?>
...
人 (前日登録 <?php echo ((is_array($_tmp=smarty_modifier_t_escape($this->_tpl_vars['sns_info']['info_member_count_yesterday']))) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
人)</dd>
    <dt>総<?php echo smarty_modifier_t_escape($this->_tpl_vars['WORD_COMMUNITY']); ?>
数</dt>
...
人</dd>
    <dt>今日の<?php echo smarty_modifier_t_escape($this->_tpl_vars['WORD_DIARY']); ?>
数</dt>
...
件 (前日<?php echo ((is_array($_tmp=smarty_modifier_t_escape($this->_tpl_vars['sns_info']['info_diary_count_yesterday']))) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
件)</dd>
    <dt>今日のメッセージ数</dt>
    <dd><?php echo ((is_array($_tmp=smarty_modifier_t_escape($this->_tpl_vars['sns_info']['info_message_count_today']))) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
件 (前日<?php echo ((is_array($_tmp=smarty_modifier_t_escape($this->_tpl_vars['sns_info']['info_message_count_yesterday']))) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
件)</dd>
</dl>
            </div>
        </div>
...
人)</dd><?php endif; ?>
    ...
    <dt>盛り上がり度No.1<?php echo smarty_modifier_t_escape($this->_tpl_vars['WORD_COMMUNITY']); ?>
</dt>
    <dd><a href="<?php echo smarty_function_t_url(array('_absolute' => 1,'m' => 'pc','a' => 'page_c_home'), $this);?>
...
</a> (書き込み<?php echo ((is_array($_tmp=smarty_modifier_t_escape($this->_tpl_vars['sns_rank']['rank_com_comment'][1][0]['count']))) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
件)</dd><?php endif; ?>
</dl>
            </div>
            <?php endif; ?>
...
<?php echo smarty_function_t_assign_sns_message(array('var' => 'sns_message'), $this);?>
        ...
        <div class="box" id="message">
            <h2>オーナー未読メッセージ <span class="unread">(<a href="<?php echo smarty_function_t_url(array('_absolute' => 1,'m' => 'pc','a' => 'page_h_message_box'), $this);?>
...
<?php echo smarty_function_t_assign_sns_new_topic(array('var' => 'new_topic_list'), $this);?>
        ...
        <div class="box" id="community">
            <h2>最新<?php echo smarty_modifier_t_escape($this->_tpl_vars['WORD_COMMUNITY']); ?>
書き込み</h2>
...
<?php $_from = $this->_tpl_vars['new_topic_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
?>
    <dt><?php echo ((is_array($_tmp=smarty_modifier_t_escape($this->_tpl_vars['item']['u_datetime']))) ? $this->_run_mod_handler('date_format', true, $_tmp, "%m/%d %H:%M") : smarty_modifier_date_format($_tmp, "%m/%d %H:%M")); ?>
</dt>
...
<?php if (@OPENPNE_DASHBOARD_URL): ?>
  <?php if (@OPENPNE_USE_HTTP_PROXY): ?>
    <?php echo smarty_function_fetch(array('file' => smarty_modifier_t_escape(@OPENPNE_DASHBOARD_URL),'proxy_host' => smarty_modifier_t_escape(@OPENPNE_HTTP_PROXY_HOST),'proxy_port' => smarty_modifier_t_escape(@OPENPNE_HTTP_PROXY_PORT),'timeout' => 5), $this);?>

  <?php else: ?>
    <?php echo smarty_function_fetch(array('file' => smarty_modifier_t_escape(@OPENPNE_DASHBOARD_URL),'timeout' => 5), $this);?>

<?php /* Smarty version 2.6.18, created on 2012-06-19 22:24:06
         compiled from file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/c_member_detail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'ext_include', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/c_member_detail.tpl', 2, false),array('function', 't_img_url', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/c_member_detail.tpl', 14, false),array('function', 't_url', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/c_member_detail.tpl', 23, false),array('modifier', 't_escape', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/c_member_detail.tpl', 5, false),array('modifier', 'date_format', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/c_member_detail.tpl', 27, false),array('modifier', 't_implode', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/c_member_detail.tpl', 40, false),array('modifier', 't_truncate', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/c_member_detail.tpl', 40, false),array('modifier', 'nl2br', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/c_member_detail.tpl', 40, false),array('modifier', 'escape', 'file:/homepage/OPENPNESAAJ/ossi_pne/webapp/modules/admin/templates/c_member_detail.tpl', 45, false),)), $this); ?>
...
"><?php echo ((is_array($_tmp=((is_array($_tmp=smarty_modifier_t_escape($this->_tpl_vars['c_member']['secure']['pc_address']))) ? $this->_run_mod_handler('t_truncate', true, $_tmp, '30') : smarty_modifier_t_truncate($_tmp, '30')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'hexentity') : smarty_modifier_escape($_tmp, 'hexentity')); ?>
...
"><?php echo ((is_array($_tmp=smarty_modifier_t_escape($this->_tpl_vars['c_member']['secure']['ktai_address']))) ? $this->_run_mod_handler('t_truncate', true, $_tmp, '30') : smarty_modifier_t_truncate($_tmp, '30')); ?>
</a><?php else: ?>&nbsp;<?php endif; ?></td>
	</tr>
	<tr>
		<th>登録メールアドレス</th>
...
<?php if ($this->_tpl_vars['from']): ?>
<p class="groupLing"><a href="?m=<?php echo smarty_modifier_t_escape($this->_tpl_vars['module_name']); ?>
&amp;a=page_<?php echo smarty_modifier_t_escape($this->_tpl_vars['hash_tbl']->hash('sns_entry_list')); ?>
" onClick="history.back(); return false;" onKeyPress="history.back(); return false;">承認待ちリストに戻る</a></p>
<?php else: ?>
<p class="groupLing"><a href="?m=<?php echo smarty_modifier_t_escape($this->_tpl_vars['module_name']); ?>
&amp;a=page_<?php echo smarty_modifier_t_escape($this->_tpl_vars['hash_tbl']->hash('list_c_member')); ?>
